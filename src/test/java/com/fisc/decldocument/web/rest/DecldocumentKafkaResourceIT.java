...
import com.fisc.decldocument.DecldocumentApp;
import com.fisc.decldocument.service.DecldocumentKafkaProducer;
import com.fisc.decldocument.service.DecldocumentKafkaConsumer;
...
public class DecldocumentKafkaResourceIT {
    ...
    @Autowired
    private DecldocumentKafkaProducer producer;

    @Autowired
    private DecldocumentKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        DecldocumentKafkaResource kafkaResource = new DecldocumentKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/decldocument-kafka/publish?message=test"))
